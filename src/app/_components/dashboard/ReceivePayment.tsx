...
const ReceivePayment = () => {
  ...
  const [input, setInput] = useState<{ email: string; amount: number }>({
    email: '',
    amount: 0,
  });
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-[446px] max-w-full overflow-hidden rounded-lg bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-black">
                  ...
                  <form className="mt-6 space-y-5" action="#" method="POST" onSubmit={handleSubmit}>
                    <div>
                    ...
                    <div>
                      ...
                      {simpleValidator.current.message('amount', input.amount, 'required')}
                    </div>
